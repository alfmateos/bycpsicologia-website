...
## FORMULARIO POST (backend original)

form_action: "usar exactamente el action del index.html actual"
form_method: "POST"
form_fields:
  - name
  - email
  - message
notes:
  - "Debe funcionar sin JS."
  - "Mantener los mismos field names que en la web original."

## NOTA
Todas las URLs de WhatsApp deben ir correctamente URL-encoded según las reglas técnicas.
